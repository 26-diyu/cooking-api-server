...
class GenericResponseGenerator:
    ...
    def generate_response(self, username: str, recipe_conversation_id: str, messages:list) -> RecipeConversation:
        response_payload = []
        ...
        recipe_conversation_id = self.relational_database.add_recipe_conversation(username,
                                                                                  ...
                                                                                  response_payload)
        recipe_conversation_title = self.relational_database.get_recipe_conversation_title(username,
                                                                                           recipe_conversation_id)
